                   ...
                   justify-center border-amber-500"
                    ...
                    {paymentMethod === 'paypal' &&
                        <div className="p-6 text-center">
                            <p className="text-gray-600 mb-4">You will be redirected to PayPal to complete your
                                payment.</p>
                            <img src="https://www.paypalobjects.com/webstatic/mktg/logo/pp_cc_mark_111x69.jpg"
                                 alt="PayPal" className="mx-auto h-12"/>
                        </div>}

                    {paymentMethod === 'cash' && (
                        <div className="p-6 text-center">
                            <p className="text-gray-600">Pay when your order is delivered. Please have the exact amount
                                ready.</p>
                        </div>
                    )}
