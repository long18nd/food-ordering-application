                    ...
                    <div className="mb-4 max-h-[500px] overflow-y-auto">
                        {activeCart?.items?.map((item: any) => (
                            <div key={item.id} className="flex items-center gap-4">
                                <div
                                    className="w-[88px] mb-4 h-[88px] bg-amber-100 rounded-md flex items-center justify-center">
                                    <img
                                        src={item.image}
                                        alt={item.name}
                        ...
                        {carts?.length !== 0 && activeCart && (
                            <div className="border-t border-gray-100 pt-4 mb-6 absolute bottom-0">
                                ...
                                <div className="flex justify-between mb-2">
                                    ...
                                    <span className="font-medium">
                                        ${activeCart?.totalAmount?.toFixed(2) ?? 0 + 5}
                                    </span>
                                </div>

                                <button
                                    className="mt-8 w-full text-white py-3 rounded-md font-medium bg-amber-600 transition-colors"
